...
export async function getServerSideProps() {
	...
	const data = {
		...
		description: "Experience the ultimate beach getaway at Kuda Villingili Resort's Beach Villa with Private Pool. Enjoy pristine white sandy beaches, crystal clear waters, and your own personal pool for the perfect blend of luxury and relaxation. Book your stay today and escape to paradise.",
		...
		size: room.size,
		title:"Maldives Resort with Private Pool | Private Beachfront Villa with Pool | Hotels with Private Pool in Maldives",
		// title: room.title,
