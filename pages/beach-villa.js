...
export const getServerSideProps = async () =>  {
	...
	const data = {
		...
		pool_size: "",
		description: "Kuda Villingili Beach Villa Resort offers complete privacy in paradise, situated on the pristine sand and immersed in the tropical lush. Lounge by the beach on the plush sunbeds, or take an aromatherapeutic bath. Book now!",
		...
		size: room.size,
		title: "Best Beach Villas in Maldives | Beach Resorts in Maldives | Beach Resort & Hotel in Maldives",
		// title: room.title,
