...
export const getServerSideProps = async () => {
	...
	const data = {
		...
		description: "Kuda Villingili Water Villa Resort is over the azure sea feature king-sized beds, spacious bathtubs, shaded dining decks overlooking the horizon, & spacious living areas, allowing the ocean breeze to flow in & out. Visit us today!",
		...
		size: room.size,
		// title: room.title,
		title: "Luxury Water Villa in Maldives | Water Villa Resort in Maldives | Water Villa Resort for Families",
